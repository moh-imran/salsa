    ...
    methods:
    {
            ...
            loadSettingList: function(url = false){                
                ...
                this.$http.get(url) .then ((response) => {
                    ...
                    if(this.settings[2].status == '1'){
                        
                        this.communitySelectionFlag = 1;
                    }
                    else{
                        this.communitySelectionFlag = 0;
                        
                    }
                    
                    console.log('check', this.settings[2]);
        ...
        changeCommunitySelection: function( event){
